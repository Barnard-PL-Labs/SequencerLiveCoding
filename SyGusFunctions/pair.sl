...
(constraint (= (patternGen 2) (pair 2 2))); 
(constraint (= (patternGen 3) (pair 3 3)));
(constraint (= (patternGen 4) (pair 4 4)));
(constraint (= (patternGen 5) (pair 5 5)));
(constraint (= (patternGen 6) (pair 6 6)));
